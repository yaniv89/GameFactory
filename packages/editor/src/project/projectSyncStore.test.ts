...
const DOCUMENT = { scenes: [{ id: "s1", name: "village", entities: [], tiles: [] }], installedModules: {}, activePack: undefined, packOverrides: {}, packTerrainRemap: {}, graphs: {}, quests: {}, dataTables: {} };
...
describe("useProjectSyncStore", () => {
  beforeEach(() => {
    ...
    useProjectStore.getState().loadDocument({ scenes: [], installedModules: {}, activePack: undefined, packOverrides: {}, packTerrainRemap: {}, graphs: {}, quests: {}, dataTables: {} });
