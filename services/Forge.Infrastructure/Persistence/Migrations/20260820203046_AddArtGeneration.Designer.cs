...
namespace Forge.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260820203046_AddArtGeneration")]
    partial class AddArtGeneration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Forge.Domain.Entities.GenerationRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("ExpandedPrompt")
                        .HasColumnType("text")
                        .HasColumnName("expanded_prompt");
                    ...
                    b.HasIndex("ProjectId")
                        .HasDatabaseName("ix_generation_requests_project_id");

                    b.HasIndex("RequestedByUserId")
                        .HasDatabaseName("ix_generation_requests_requested_by_user_id");
            ...
            modelBuilder.Entity("Forge.Domain.Entities.GenerationVariation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Forge.Domain.Entities.GenerationRequest", b =>
                {
                    b.HasOne("Forge.Domain.Entities.Project", "Project")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_generation_requests_projects_project_id");

                    b.HasOne("Forge.Domain.Entities.User", "RequestedBy")
                        .WithMany()
                        .HasForeignKey("RequestedByUserId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_generation_requests_domain_users_requested_by_user_id");
                    ...
                    b.HasOne("Forge.Domain.Entities.Workspace", "Workspace")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_generation_requests_workspaces_workspace_id");
            ...
            modelBuilder.Entity("Forge.Domain.Entities.GenerationVariation", b =>
                {
                    b.HasOne("Forge.Domain.Entities.GenerationRequest", "GenerationRequest")
                        .WithMany("Variations")
                        .HasForeignKey("GenerationRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_generation_variations_generation_requests_generation_reques");
